...
namespace CommonUtils
{
    public  class HttpClientUtil
    {
        ...
        //public async Task<Y> PostWithJson<T, Y>(string path,T value, IDictionary<string,string> cookie=null)
        //{
        ...
        public async Task<T> PostWithJson<T>(string path, object value, IDictionary<string, string> cookie = null)
        {
